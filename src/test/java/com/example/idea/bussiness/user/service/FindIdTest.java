...
public class FindIdTest {
    ...
    public void testFindUserId_UserExists() {
        ...
        when(userRepository.findByNameAndEmail(name, email)).thenReturn(Optional.of(mockUser));
    ...
    public void testFindUserId_UserDoesNotExist() {
        ...
        when(userRepository.findByNameAndEmail(name, email)).thenReturn(Optional.empty());
