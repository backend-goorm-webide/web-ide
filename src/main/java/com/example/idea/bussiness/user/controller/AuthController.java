...
import com.example.idea.bussiness.user.dto.LoginDto;
import com.example.idea.config.jwt.JwtFilter;
import com.example.idea.config.jwt.TokenProvider;
import com.example.idea.config.jwt.dto.TokenDto;
...
public class AuthController {
    ...
    public ResponseEntity<TokenDto> authorize(@Valid @RequestBody LoginDto loginDto) {
        ...
        UsernamePasswordAuthenticationToken authenticationToken =
                new UsernamePasswordAuthenticationToken(loginDto.getUserId(), loginDto.getPwd());
